...
public class BTree extends AbstractSet implements Set
{
	...
	/**
	 * Constructs a BTree of default order 50
	 */
	public BTree()
	{
		this(50);
	...
	/**
	 * Constructs a BTree of specified order
	...
	/**
	 * Checks whether the tree contains the given object
	 * @param the object to be checked
	 * @return true if it contains the object 'Obj'
	 */
	...
	/*
	 * Constructs the tree from a file
