...
/**
 * The class Infinity contains methods for checking whether the
 * input ends with a 'Infinitive suffix'. If so, removes it from the input
 * and store it as 'Infinitive suffix' in output
 */
public class Infinity
{
	...
	/**
	 * Checks whether the input ends with the Infinitive suffix ka/kka
	...
	/**
	 * Checks whether the input ends with the Infinitive suffix a
	 * @param s Stack where analysed output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any Infinitive endings
	 * @param s Stack where analysed output is stored
	 */
	...
	/**
	 * Checks whether the input ends with the Future Negative marker - mAtt
	 * @param s Stack where analysed output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any infinitive
	 * @param s Stack where analysed output is stored
	 */
