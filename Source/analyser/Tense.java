...
/**
 * The class Tense contains methods for checking whether the
 * input ends with 'Tense Marker'. If so, removes it from the input
...
public class Tense
{
	...
	/**
	 * Checks whether the input ends with 'Tense Marker for human'
	 * If so, removes it from the input and store it in output
	 * @param s Stack where analysed output is stored
	 * @return true if the input ends with 'Tense Marker'
	 */
