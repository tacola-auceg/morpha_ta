...
/**
 * Class contains Tamil suffixes
 */
public class Constant
{

	//postposition
	static byte[] anpadi = 		TabConverter.convert("Üù¢ð®");
	static byte[] inpadi = 		TabConverter.convert("Þù¢ð®");

	//prefix
	static byte[] mm = 			TabConverter.convert("ñ¢ñ¢");
	static byte[] n_n_ = 		TabConverter.convert("ï¢ï¢");
	static byte[] vv = 			TabConverter.convert("õ¢õ¢");

	static byte Alum[] = 		TabConverter.convert("Ý½ñ¢");

	//tense
	static byte sen[] = 		TabConverter.convert("ªêù¢");
	static byte iin[] = 		TabConverter.convert("ßù¢");
	static byte men[] = 		TabConverter.convert("ªñù¢");
	static byte ven[] = 		TabConverter.convert("ªõù¢");

	//png
	static byte Athathu[] = 	TabConverter.convert("Ýî¶");
	static byte Athavar[] = 	TabConverter.convert("Ýîõó¢");

	//aux
	static byte paNNu[] =	 	TabConverter.convert("ðí¢µ");
	static byte iy[] = 			TabConverter.convert("Þò¢");

	//Misc
	static byte koNdiru[] = {14,10,19,18,3,25,5};
	static byte iRRu[] = {3,30,30,5};


	static byte ththAn[] = {20,20,2,31};
	static byte n_thAn[] = {21,20,2,31};
	static byte kayil[] = {14,9,24,3,26};
	static byte[] poothu = TabConverter.convert("«ð£¶");
	...
	static byte E[] = {8};
	static byte ellaam[] = 	TabConverter.convert("âô¢ô£ñ¢");
	...
	static byte thAm[] = {20,2,23};

	static byte ithu[] = {3,20,5};
	static byte ivaikaL[] = {3,27,9,14,1,29};
	...
	static byte[][] auxSuffixVP_u = new byte[PAST_TM_HUMAN.length*
		VP_SUFFIX.length+2][];
	...
	static
	{
		...
		for(int i=0; i<PAST_TM_HUMAN.length;i++)
		{
			...
			{
				auxSuffixVP_u[c] = ByteMeth.addArray(PAST_TM_HUMAN[i],VP_SUFFIX[j]);
				c++;
			}
		}
		auxSuffixVP_u[c] = i;
