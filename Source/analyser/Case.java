...
/**
 * The class Case contains methods for checking whether the
 * input ends with a 'case marker'. If so, removes it from the input
 * and store it as 'case marker' in output
 */
public class Case
{
	...
	/**
	 * Checks whether the input ends with the case marker
	 * @param s Stack where analysed output is stored
	 * @param pronominal true if the case is after a pronominal suffix
	 * @return true if the input ends with any case
	 */
