 ...
 * input ends with any imperative markers, finite verb, etc
 */
public class VerbMisc
{
	...
	/**
	 * Checks whether the input ends with 'umpadi'
	...
	/**
	 * Checks whether the input ends with past tense + Al
	 * @param s Stack where analysed input/output is stored
	 */
	public static boolean pastTM_Al(Stack s)
	{
		...
		{
			//System.out.println(x + "TM_Alum");
			s.pop();
			s.push(new Entry(Constant.um,Tag.Clitic));
			s.push(new Entry(Constant.Al,Tag.Conditional));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.Alum.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
	...
	/**
	 * Checks whether the input ends with any imperative singular
	 * marker - 1
	 * @param s Stack where analysed input/output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any imperative plural
	 * marker - 1
	 * @param s Stack where analysed input/output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any finite verb
	 * @param s Stack where analysed input/output is stored
	 */
	public static boolean finiteVerb(Stack s)
	{
		//System.out.println(x + "Verb Misc - Finite Verb");
		byte[] topElmt = ((Entry)s.peek()).getPart();
		byte[] oldTopElmt = topElmt;
	...
	/**
	 * Checks whether the input ends with any adverbial particle
	 * @param s Stack where analysed input/output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any pronominal suffix
	 * @param s Stack where analysed input/output is stored
	 */
