...
/**
 * The class Auxillary contains methods for checking whether the
 * input ends with an auxillary. If so, removes it from the input
 * and store it as auxillary in output
 */
public class AuxiliaryVerb
{
	...
	/**
	 * Checks whether the input ends with the auxillary-infinitive
	...
	/**
	 * Checks whether the input ends with the auxillary-verbal participle
	 * @param s Stack where analysed input/output is stored
	 */
...
if(BooleanMethod.hasAux(topElmt))
{
		...
		{
			//System.out.println(x + "tharu");
			s.pop();
			s.push(new Entry(Constant.tharu,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.tharu.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			//last
			Sandhi.th(s);
			return true;
		...
		if(ByteMeth.endsWith(topElmt,Constant.mudi) &&
			!ByteMeth.isEqual(topElmt,Constant.pati))
		{
			//System.out.println(x + "mudi");
			s.pop();
			s.push(new Entry(Constant.mudi,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.mudi.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			return true;
		}
		//thaLLu
		if(ByteMeth.endsWith(topElmt,Constant.thaLLu) &&
			!ByteMeth.isEqual(topElmt,Constant.pati))
		{
			//System.out.println(x + "thaLLu");
			s.pop();
			s.push(new Entry(Constant.thaLLu,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.thaLLu.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			Sandhi.th(s);
			return true;
		}
		...
		if(ByteMeth.endsWith(topElmt,Constant.sA) &&
			!ByteMeth.isEqual(topElmt,Constant.pati))
		{
			//System.out.println(x + "sA");
			s.pop();
			s.push(new Entry(Constant.sA,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.sA.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			Sandhi.s(s);
			return true;
		}
	...
	/**
	 * Checks whether the input ends with the auxillary-verbal participle/infinitive
	 * @param s Stack where analysed input/output is stored
	 */
...
if(BooleanMethod.hasAux(topElmt))
{
		...
		{
			//System.out.println(x + "paNNu");
			s.pop();
			s.push(new Entry(Constant.paNNu,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.paNNu.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			Sandhi.p(s);
			return true;
		}
		...
		{
			//System.out.println(x + "koNdiru");
			s.pop();
			s.push(new Entry(Constant.koNdiru,Tag.AuxVerb));
			topElmt = ByteMeth.subArray(topElmt,0,topElmt.
				length-Constant.koNdiru.length);
			s.push(new Entry(topElmt,-1,oldTopElmt));
			Sandhi.k(s);
			return true;
		}
	...
	/**
	 * Checks whether the input ends with any type of auxillaries
	 * @param s Stack where analysed input/output is stored
	 */
