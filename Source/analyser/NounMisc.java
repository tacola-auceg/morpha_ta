 ...
 * input ends with any ajectival/adverbial suffixes
 */
public class NounMisc
{
	...
	/**
	 * Checks whether the input ends with any adjectival suffix
	...
	/**
	 * Checks whether the input is angu/ingu/engu
	 * @param s Stack where analysed input/output is stored
	 */
	...
	/**
	 * Checks whether the input ends with any adverbial suffix
	 * @param s Stack where analysed input/output is stored
	 */
	 ...
	 * @param inputString the input to be analysed
	 */
	public static boolean checkNumber(Stack allStk, String inputString)
	{
		...
		try
		{
			...
			s.push(new Entry(TabConverter.convert(inputString),Tag.Noun));//temp
			allStk.push(s);
			return true;
